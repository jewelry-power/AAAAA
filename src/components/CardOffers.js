                    ...
                    <div class="  lg:grid-cols-3 justify-center">
                        ...
                        <div class="group border-gray-100/30 flex w-full max-w-xs flex-col self-center overflow-hidden rounded-lg border  bg-gray-100 shadow-md">
                            <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href='#'>
                                <img class="peer absolute top-0 right-0 h-full w-full object-cover"  src={product.image} alt={product.title} width={90} height={90} />
                            ...
                            <div class="mt-4 px-5 pb-5">
                                <a href="#">
                                    <h5 class="text-xl tracking-tight text-black">{product.title}</h5>
                                </a>
                                <div class="mt-2 mb-5 flex items-center justify-between">
                                    <p>
                                        <span class="text-3xl font-bold text-black">Price: ${product.price}</span>
                                        <span class="text-sm text-black line-through">Category: {product.category}</span>
                                    </p>
                                </div>
